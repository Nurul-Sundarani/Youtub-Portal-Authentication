...
class ResourcesInstruction extends Component{
    render(){
        return(
            <div>
                <Header />
                <ul className="list-group">
                    ...
                    <li className="list-group-item">If the button displays Sign Out , i.e you are logged in try to access YouTube Portal. You will be allowed to access it.</li>
...
export default ResourcesInstruction;